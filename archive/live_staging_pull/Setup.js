...
function initializeSystem() {
  try {
    ...
    initSheet(ss, CONFIG.SHEETS.TERMINATIONS, [
      ...
      'Site', 'Term Date', 'Reason', 'HR Approved (Manager)', 'Has Reports', 'Reassign Reports To', 
      'Systems to Deactivate', 'Email Forwarding', 'Drive Files Transfer', 'Inbox Delegate', 'Account Duration', 'Vacation Message',
    ...
    initSheet(ss, CONFIG.SHEETS.ACTION_ITEMS, [
      'Workflow ID', 'Task ID', 'Category', 'Task Name', 'Description', 'Assigned To', 'Status', 'Created Date', 'Completed Date', 'Notes', 'Closed By'
    ]);
